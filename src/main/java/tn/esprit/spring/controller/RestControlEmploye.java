...
public class RestControlEmploye {
	...
	public Employe ajouterEmploye(@RequestParam String prenom, @RequestParam String nom, @RequestParam String email,
			@RequestParam boolean isActif, @RequestParam Role role) {
	...
	public int ajouterContrat(@RequestParam String typeContrat, @RequestParam float salaire) {
		Contrat contract = new Contrat();
		contract.setTypeContrat(typeContrat);
		contract.setSalaire(salaire);
		iemployeservice.ajouterContrat(contract);
